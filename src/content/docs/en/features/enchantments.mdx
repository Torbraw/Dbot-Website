...
You can enchant your items using enchant gems <Image width="24" height="24" alt="enchant-gems" src='https://d2lqwktucnc67y.cloudfront.net/icons/EnchantGems.png' /> with the `/enchant` command.
